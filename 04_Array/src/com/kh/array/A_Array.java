...
public class A_Array {
	 ...
	 * 			 a = 20;
	 * 
	 * 배열 : 하나의 공간에 여러 개의 값을 담을 수가 있음(단. 같은 자료형의 값으로만 가능)
	...
	public void method1() {
		 ...
		 * 
		 * 2) 배열 할당
		 * 이 배열에 몇 개의 값들을 보관할 건지 배열의 크기를 지정해 주는 과정
...
//		System.out.println(arr[0]);
		...
		// 각각의 인덱스 값을 확인하기 위해서는 []블록을 통해 내가 확인하고자 하는 인덱스(방번호)를 제시해 줘야 함
		// 그럼 arr에 전체 담겨있는 값을 확인하고 싶다면?
		System.out.println(arr); // 실제 arr이라는 값에는 주소 값이 담겨있음
		// [I@1888ff2c 여기서 @ 기준으로 우측은 참조하고 있는 heap 주소 값
		// [ : 배열임을 나타냄
		// I : int 자료형을 의미함.
	}
	...
	public void method2() {
		...
		/*
		 * 우선 대입 연산자 기준 왼쪽이 먼저 실행되므로 arr이라는 int형 배열 박스가 먼저 만들어짐(stack 영역에)
		 * 그다음 int[5] 짜리 방이 heap 영역에 생성됨(new 키워드가 붙은 녀석은 항상 heap 영역에 값이 할당됨)
	...
	public void method3() {
		...
		for(int i=0; i<iArr.length; i++) { // i의 값은 0, 1, 2
		 ...
		 * -> heap이라는 영역에는 절대로 빈 공간이 존재할 수가 없기 때문에
	...
	public void method4() {
		...
		System.out.println(arr[4]); //크기 = n(5), 마지막 인덱스 = n(5) - 1 =4
	...
	public void method5() {
		...
		//int i2 = null; typeMissMatch -> null 값을 int 자료형에 넣을 수 없음
		int[] arr = null; // null 값 할당 가능. 주소값을 담을 수 있는 변수의 기본값은 null;
		
		//System.out.println(arr.hashCode());
		/*
		 * 기본값이 null인 변수를 가지고 메서드를 호출한다거나 특정 어딘가에 접근하고자 한다면 무조건 오류 발생
		 * -> NullPointerException
		 * ex) arr.hashCod(), arr.length
		 */
	}
...
//		for(int i=0; i<arr.length; i++) { // 내가 한 거
...
//		}
		 ...
		 * 기존에 참조하고 있던 연결이 끊기고 새로운 주소값을 참조
		 * 
	...
	public void method7() {
		...
		// aar1 -> arr1의 heap 영역의 "주소값"
		// aar2 -> arr2의 heap 영역의 "주소값"
...
//			arr[i] = (int) (Math.random() * 100 + 1);
//		}
//		for(int i=0; i<arr.length; i++) { // 이렇게도 가능하고 위 코드처럼도 가능
//			System.out.printf("arr[%d] : %d \n", i, arr[i]);
//		}
	}
	...
	public void method10() {
		// 사용자에게 문자열을 하나 입력받은 후 각각의 문자들을 뽑아서 char 배열에 옮겨 담기
		//1. 사용자에게 문자열 입력받기
...
//		}
	...
	public void method11() {
		// 1. 사용자에게 배열의 길이 입력받은 후 해당 크기만큼 정수 배열 생성
