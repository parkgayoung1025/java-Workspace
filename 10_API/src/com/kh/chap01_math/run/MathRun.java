...
// import java.lang
// 생략 가능. 보이진 않지만 항상 자동으로 java.lang 패키지가 import 되어 있음.
...
public class MathRun {
	...
	public static void main(String[] args) {
		...
		// 최소값 => Math.min(int, int) : 반환값 int형
		System.out.println("최소값 : " + Math.min(5, 10));

		// 최대값 => Math.max(int, int) : 반환값 int형
		 ...
		 * - 모든 메서드 => static 메서드
		 * 
		 * 모든게 다 static이기 때문에 Math.필드 or Math.메서드명으로 다 접근 가능(객체 생성할 필요가 없음)
		 * Math 클래스의 생성자가 private이다.(객체 생성 불가)
		 */
	}
