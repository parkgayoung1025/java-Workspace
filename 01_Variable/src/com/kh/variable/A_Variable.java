...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("박가영 : "+ (11000 * 4 * 5) +"원 입니다.");
		...
		System.out.println("박가영 : "+(pay * time * day)+"원 입니다.");
	...
	public void declareVariable( ) {
		/*
		 * 변수의 선언(값을 기독하기 위한 변수를 메모리 공간에 확보해두겠다 = 박스를 만들겠다)
		 * [표현법] 자료형 변수명;
		 * 
		 ...
		 * 
		 * 주의할점
		 * 1. 변수명은 소문자로 시작하게끔 지어줄것. (단, 낙타등표기법(두번째단어부턴 대문자)지키기)
		...
		sNum = 2;
		iNum = 4;
		lNum = 8L; //long 자료형임을 알려주기위해 소문자나 대문자 L을 표기(대문자 L을 더 권장)->선택사항
		
		fNum = 4.0f; //반드시 f를 붙여줘야한다.->필수사항
		dNum = 8.0;
		...
		ch = 'A'; //반드시 ''(작은따옴표)안에 넣어줘야함
		str = "ABC"; //반드시 ""(쌍따음표)안에 넣어줘야함isTrue = true;
