...
public class F_Logical {
	 ...
	 * 
	 * AND 연산자 : 논리값 && 논리값
	 *            왼쪽, 오른쪽 논리값이 둘 다 TRUE여야 최종결과가 TRUE가 반환됨
	 *            그리고 , ~ 이면서 , ~이고, 뿐만아니라
	 *            
	 * OR 연산자 : 논리값 || 논리값
	...
	public void method4() {
		 ...
		 * 실행할 때 오류는 나지 않지만, result1 결과값이 어차피 false인데 왜 작성한 구문인지 물어보는 것
		 * 
		 */
		System.out.println(num1);
		
		boolean result2 = false || (++num1 > 0);
		System.out.println(num1);
	}
