...
public class ArrayForeach {
	...
	public static void main(String[] args) {
		...
		/*
		 * 여태까지 사용했던 반복문 : for loop, 기본 반복문 새롭게 배울 반복문 : 향상된/개선된 for문
		 * 
		 * for each문(향상된 for문, 개선된 for문) 배열 또는 컬렉션과 사용됨 배열 또는 컬렉션의 0번 인덱스부터 마지막 인덱스까지
		 * 순차적으로 접근할 목적일 때
		 * 
		 * 초기식 조건식 증감식 없음 반복하는 횟수는 배열 또는 컬렉션의 크기
		 * 
		 * for(순차적으로 접근한 값을 담아줄 변수선언 : 순차적으로 접근할 배열/컬렉션) { 실행할 코드 }
		 */

		int[] arr2 = { 40, 50, 60 };

		for (int num : arr2) { // arr2라는 배열은 0번 인덱스부터 순차적으로 접근하면서
								// int num이라는 변수에 arr2의 각 인덱스의 값을 저장함
